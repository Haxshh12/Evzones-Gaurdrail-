# Development Instructions for Harshjjj NVR

This document provides coding guidelines and best practices for contributing to Harshjjj NVR, a complete and local NVR designed for Home Assistant with AI object detection.

## Project Overview

Harshjjj NVR is a realtime object detection system for IP cameras that uses:
