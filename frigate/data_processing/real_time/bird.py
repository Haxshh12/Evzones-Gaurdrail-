...
try:
    ...
    try:
        ...
        # Use TensorFlow Lite from TensorFlow on Windows
        try:
            import tensorflow as tf
            Interpreter = tf.lite.Interpreter
        except ImportError:
            # Bird processing not available on this platform
            Interpreter = None
            logger.warning("Bird processing not available: TensorFlow Lite not found")
