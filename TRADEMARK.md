...
This document outlines the policy regarding the use of the trademarks associated with the Harshjjj NVR project.

## 1. Our Trademarks

The following terms and visual assets are trademarks (the "Marks") of **Harshjjj**:
...
You may not use the Marks except as explicitly permitted by this policy.

## 3. Acceptable Use

- You may use the Mark when referring to the original Harshjjj NVR software
- You may create derivative works but must rename them and remove all trademark references
- You must not imply endorsement by Harshjjj without explicit permission
