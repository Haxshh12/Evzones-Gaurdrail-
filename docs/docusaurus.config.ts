...
const config: Config = {
  ...
  url: "https://harshjjj-nvr.local",
  baseUrl: "/",
  onBrokenLinks: "throw",
  onBrokenMarkdownLinks: "warn",
  favicon: "img/branding/favicon.ico",
  organizationName: "harshjjj",
  projectName: "nvr",
  themes: [
  ...
  themeConfig: {
    ...
    inkeepConfig: {
      ...
      aiChatSettings: {
        ...
        getHelpCallToActions: [
          {
            name: "GitHub",
            url: "https://github.com/harshjjj/nvr",
            icon: {
              builtIn: "FaGithub",
            },
          },
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/harshjjj/nvr',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: "Discussions",
              href: "https://github.com/harshjjj/nvr/discussions",
            },
          ],
        },
      ],
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/harshjjj/nvr/edit/master/docs/",
